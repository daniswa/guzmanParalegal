...
<html lang='en-US'>
<head>
    <title>Guzman Paralegal Services</title>
    <meta charset='utf-8'>
    ...
    <?php
        ...
        if($_SESSION['language'] == 'spanish'){
            ...
            echo "<section>
                ...
                <div id='content'>
                    <p class='title'>Guzman Paralegal Services</p>
                    <p>Somos un proveedor de servicios de asistente legal ubicado en Reseda California.</p>
                    <p>Estamos orgullosos de servir a todo el Valle de San Fernando y todas las &#225;reas circundantes.</p>
                    <p>Ofrecemos los servicios de asistencia legal, as&#237; como la preparaci&#243;n de documentos.</p>
                    <p>Nuestro personal experto y conocedor est&#225; listo para servirle!</p>
                </div>
                <img id='homePic' src='images/homePic.jpg'>
            </section>";
            ...
            echo "<section>
                ...
                <div id='servicesSidebar'>
                    ...
                    <ul id='services'>
                        ...
                        <li class='services'><p>Wills and Trusts</p></li><br>
                ...
                <div id='content'>
                    <p class='title'>Guzman Paralegal Services</p>
                    <p>We are a paralegal service provider located in Reseda California.</p>
                    <p>We proudly serve the entire San Fernando Valley and all surrounding areas.</p>
                    <p>We offer paralegal services as well as document preparation.</p>
                    <p>Our skilled and knowledgable staff is ready to serve you!</p>
                </div>
                <img id='homePic' src='images/homePic.jpg'>
            </section>";
            include 'footer.php';
