    ...
    <?php
        ...
        if($_SESSION['language'] == 'spanish'){
            ...
            echo "<section>
                ...
                <div class='profile'>
                    <img id='elizabethPic' src='images/gpsElizabeth.jpg'>
                    <p class='bioA'>Elizabeth R. Ahboot, ESQ</p>
                    <p class='bioA'>Abogada</p><br>
                    <p class='bioA'>BIOGRAF&#205;A MUY PRONTO!</p>
                </div>
                <div class='profile'>
                    <img id='anaPic' src='images/gpsAna.jpg'>
                    <p class='bioB'>Ana Guzman</p>
                    <p class='bioB'>Paralegal</p><br>
                    <p class='bioB'>BIOGRAF&#205;A MUY PRONTO!</p>
                </div>
            </section>";
            ...
            echo "<section>
                ...
                <div class='profile'>
                    <img id='elizabethPic' src='images/gpsElizabeth.jpg'>
                    <p class='bioA'>Elizabeth R. Ahboot, ESQ</p>
                    <p class='bioA'>Attorney</p><br>
                    <p class='bioA'>BIO COMING SOON!</p>
                </div>
                <div class='profile'>
                    <img id='anaPic' src='images/gpsAna.jpg'>
                    <p class='bioB'>Ana Guzman</p>
                    <p class='bioB'>Paralegal</p><br>
                    <p class='bioB'>BIO COMING SOON!</p>
                </div>
            </section>";
            include 'footer.php';
        }
